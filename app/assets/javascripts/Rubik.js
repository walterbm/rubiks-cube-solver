...
var Rubik = Extends(THREE.Object3D, {
    ...
    constructor : function( Np, sidep, dspp, colorsp) {
        ...
        if (undef !== sidep && sidep>0)  side = sidep;
        if (undef !==Np && Np>0)  N = parseInt(Np);
        if (undef !== dspp && dspp>0) dsp = dspp;
    ...
    scramble : function( nsteps ) {
        ...
        if (typeof nsteps=='undefined' || nsteps <= 0) 
    ...
    getCubeletSeenCoords : function( cubelet ) {
        ...
        else  c = this.rubik.cubelets[cubelet];
